...
export default function EdgeVisualizer(edges: ForceGraphEdge[]) {
  ...
  EdgeVisualizer.prototype = Object.create(THREE.Mesh.prototype);
  EdgeVisualizer.prototype.constructor = EdgeVisualizer;
  // helper method for changing the uTime uniform
  Object.defineProperty(EdgeVisualizer.prototype, 'time', {
    get: function () {
